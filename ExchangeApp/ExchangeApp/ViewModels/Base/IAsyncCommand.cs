...
namespace ExchangeApp.ViewModels.Base
{
    ...
    /// Every asynchronous operation, which is bound to view, should inform the view about it's state - whether it's still performing background operation,
    ...
    public interface IAsyncCommand : IBindableCommand
    {
        ...
        /// <summary>
        /// This method is a wrapper around <see cref="ICommand.Execute"/> method, to allow clients await the result, instead of 
